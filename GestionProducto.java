...
public class GestionProducto {
    ...
    public GestionProducto(int clienteId, Conexion conexion) {
        ...
        this.conexion = conexion;  // Inicializar la variable conexion
    }
    ...
    public GestionProducto(int dummy, Connection connection) {
        this.connection = connection;  // Inicializar la conexión
        this.conexion = new Conexion();  // Inicializar la variable conexion
